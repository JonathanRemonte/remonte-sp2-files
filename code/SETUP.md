...
3. Copy the `/code/bioinfoPortal-sp-code` folder to `/home/admin/bioinformatics` folder
...
- Experiments/ -> /home/admin/bioinformatics/mapman/usadellab.github.io/MapManJS/Experiments/
- secrets/ -> /home/admin/bioinformatics/secrets/
- drupaldb_backup.sql -> /home/admin/bioinformatics/postgres-init/backups/drupaldb_backup.sql
- drupal7db_backup.sql -> /home/admin/bioinformatics/postgres-init/backups/drupal7db_backup.sql
